...
<link rel="shortcut icon" href="/Images/favicons/favicon.ico" type="image/x-icon"></link>
...
<img src="./images/catalog_underline.png" alt="" id="catalog_underline"></img>
</div>
  ...
  <div className="left">
        ...
        <div id="applied_filters_sort">
                <p id="reset_filters">Reset Filters<svg width="16px" height="16px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M4 6H20M7 12H17M9 18H15" stroke="#000000" stroke-width="2" stroke-linecap="round"
      ...
      <div class="selectOne">
        ...
        <input
          ...
          checked={Houseplants}
          onChange={(e) => {
            SetHouseplants(e.target.checked);
            
          }}
        />
        <label for="">Houseplants</label>
        <br />
        <input
          type="checkbox"
  ...
  <div className="card-list">
   ...
   <div className="card-img"><img id="bgimg" src={item.img} alt={item.name}></img></div>
